...
export const TreatmentCard: React.FC<TreatmentCardProps> = ({
  ...
  return (
    <div
      className={`group relative bg-white rounded-xl shadow-sm hover:shadow-xl transition-all duration-500 overflow-hidden border border-gray-100 hover:border-primary/30 ${featured
        ? "lg:hover:-translate-y-2 hover:scale-[1.01]"
        : "lg:hover:-translate-y-1 hover:scale-[1.01]"
        }`}
    >
      {/* Featured Badge */}
      {featured && (
